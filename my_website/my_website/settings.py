...
This module configures Django settings including database, authentication,
static files, and email backend. Environment variables are loaded from
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    'django-insecure-2i$ysxom_ek2r+qj1y@!r_gf5h48&7yo6!xkov0bb$61c5=ndw',  # Dev only
)
...
# Configured for Gmail SMTP - adjust for other providers
